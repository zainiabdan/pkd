...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/dark-admin/bootstrap/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/dark-admin/font-awesome/css/font-awesome.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/dark-admin/css/local.css') }}" />
{{--     
    <link href="{{ URL::asset('assets/css/plugins/datepicker3.css') }} " rel="stylesheet">
    <link href="{{ URL::asset('assets/css/plugins/datatables.min.css') }} "  rel="stylesheet" >
    <link href="{{ URL::asset('assets/css/plugins/responsive.dataTables.min.css') }} "  rel="stylesheet" >
    <link href="{{ URL::asset('assets/css/plugins/clockpicker.css') }} " rel="stylesheet"  > --}}


    <script type="text/javascript" src="{{ URL::asset('assets/dark-admin/js/jquery-1.10.2.min.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('assets/dark-admin/bootstrap/js/bootstrap.min.js') }}"></script>
